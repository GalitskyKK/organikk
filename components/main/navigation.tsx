    ...
    <>
      <aside
        ...
        <div
          ...
          onClick={collapse}
          className={cn(
            'h-6 w-6 text-muted-foreground rounded-b-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition',
